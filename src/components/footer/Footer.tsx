    ...
    <footer className="footer">
      ...
      <ul className="footer-contact-links">
        <Link
          ...
          icon-attribute="github"
          href="https://github.com/DF27ARTS"
          target="_blank"
        >
        ...
        <Link
          className="contact-link"
          icon-attribute="linkedIn"
          href="https://www.linkedin.com/in/diego-fernando-rojas-carrillo-full-stack-developer/"
          target="_blank"
        >
          <div className="icon-container">
            <svg
        ...
        <Link
          className="contact-link"
          icon-attribute="twitter"
          href="https://twitter.com/_DF_Fernando"
          target="_blank"
        >
          <div className="icon-container">
            <svg
